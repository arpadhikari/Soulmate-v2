...
const maleNames = ["Ram", "Shyam", "Hari", "Gopal", "Suresh", "Ramesh", "Kishor", "Manoj", "Bikash"];
...
const genderPreferences = ["male", "female"];
...
const seedUsers = async () => {
    try {
        await mongoose.connect('mongodb+srv://arpanzyy:W25nhz5jJsPKBcVK@cluster0.cjdfe.mongodb.net/soul_db?retryWrites=true&w=majority&appName=Cluster0');
